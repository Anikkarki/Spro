...
<div align="center" class="post-title"><h2>Do you want to delete this Category?</h2></div>
...
<div class="login-style">
      <div class="filler"></div>
        <div class="filler"></div>
      <form method="POST" action="core/category_delete_process.php">
        <div class="login-user"><input type="hidden" name="C_ID" value="<?php echo $arr['C_ID']?>"></div><br>
        <div class="login-user">Title  <input type="text" name="C_name" value="<?php echo $arr['C_name']?>"></div><br>
